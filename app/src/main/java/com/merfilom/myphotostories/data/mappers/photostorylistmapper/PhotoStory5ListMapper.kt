...
class PhotoStory5ListMapper: PhotoMapperInterface<List<Story5Entity>, List<Story5>> {
    override fun mapFromEntity(type: List<Story5Entity>): List<Story5> {
        ...
        type.forEach { photoEntity ->
            listPhoto.add(
                Story5(
                    idStory5 = photoEntity.idStory5Entity,
                    photoStory5 = Photo5(
                        id = photoEntity.idStory5Entity,
                        title = photoEntity.photoStory5Entity.titleEntity,
    ...
    override fun mapToEntity(type: List<Story5>): List<Story5Entity> {
        ...
        type.forEach { photo ->
            listPhotoEntity.add(
                Story5Entity(
                    idStory5Entity = photo.idStory5,
                    photoStory5Entity =  Photo5Entity(
                        idEntity = photo.idStory5,
                        titleEntity = photo.photoStory5.title,
