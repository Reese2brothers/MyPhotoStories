...
class PhotoStory1ListMapper: PhotoMapperInterface<List<Story1Entity>, List<Story1>> {
    override fun mapFromEntity(type: List<Story1Entity>): List<Story1> {
        ...
        type.forEach { photoEntity ->
            listPhoto.add(
                Story1(
                    idStory1 = photoEntity.idStory1Entity,
                    photoStory1 = Photo1(
                        id = photoEntity.idStory1Entity,
                        title = photoEntity.photoStory1Entity.titleEntity,
    ...
    override fun mapToEntity(type: List<Story1>): List<Story1Entity> {
        ...
        type.forEach { photo ->
            listPhotoEntity.add(
                Story1Entity(
                    idStory1Entity = photo.idStory1,
                    photoStory1Entity =  Photo1Entity(
                        idEntity = photo.idStory1,
                        titleEntity = photo.photoStory1.title,
